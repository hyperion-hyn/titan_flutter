...
//  }
  ...
  _initSetting() async {
    ...
    BlocProvider.of<SettingBloc>(context)
        .add(UpdateSettingEvent(areaModel: areaModel, languageModel: languageModel, quotesSign: quotesSign));
  }
...
//    if (false) {
      bool isLogged = prefs.containsKey(PrefsKey.SHARED_PREF_USER_TOKEN_KEY);
      if (isLogged) {
        //launch dashboard
        ...
        BlocProvider.of<RootPageControlBloc>(context)
            .add(SetRootPageEvent(page: BlocProvider<LoginBloc>(create: (context) => LoginBloc(), child: LoginPage())));
      }
    } else {
      //launch setting

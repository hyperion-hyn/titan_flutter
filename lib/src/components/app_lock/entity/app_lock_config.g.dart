...
Map<String, dynamic> _$AppLockConfigToJson(AppLockConfig instance) => <String, dynamic>{
...
Map<String, dynamic> _$WalletLockToJson(WalletLock instance) => <String, dynamic>{

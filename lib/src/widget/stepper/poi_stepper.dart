...
///  * [Step]
///  * <https://material.io/archive/guidelines/components/steppers.html>
class PoiStepper extends StatefulWidget {
  ...
  const PoiStepper({
    ...
    @required this.steps,
    this.physics,
    this.type = PoiStepperType.vertical,
    this.currentStep = 0,
    this.onStepTapped,
    this.onStepContinue,
    this.onStepCancel,
...
class _StepperState extends State<PoiStepper> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(PoiStepper oldWidget) {
  ...
  TextStyle _titleStyle(int index) {
    ...
    switch (widget.steps[index].state) {
      ...
      case StepState.disabled:
        return textTheme.body1.copyWith(
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.type) {
      case PoiStepperType.vertical:
        return _buildVertical();
      case PoiStepperType.horizontal:

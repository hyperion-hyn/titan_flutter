...
class TransferHistoryDao {
  ...
  static const String kColumnPassword = 'password';
  ...
  Future<TransactionDetailVo> insertOrUpdate(TransactionDetailVo entity) async {
    if (entity.id == null) {
      ...
      entity.id = await (await _db).rawInsert(
          ...
          ', $kColumnTime, $kColumnType, $kColumnSymbol, $kColumnAmount, $kColumnGas, $kColumnGasPrice, $kColumnContractAddress, $kColumnLocalTransferType, $kColumnPassword) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)',
          [
            entity.hash,
            entity.nonce,
            entity.fromAddress,

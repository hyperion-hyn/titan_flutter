...
class NcovPoiEntity extends Object {
  ...
  NcovPoiEntity.setPid(this.id, this.location);

  factory NcovPoiEntity.fromJson(Map<String, dynamic> srcJson) =>
      _$NcovPoiEntityFromJson(srcJson);

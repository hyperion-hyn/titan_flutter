...
import 'package:titan/src/pages/me/model/power_detail.dart';
...
//  }
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                    "${Const.DOUBLE_NUMBER_FORMAT.format(MeUtils.powerForShow(userInfo.totalPower))} T",
  ...
  HashRateVo _convertPowerDetailToHashRateVo(PowerDetail powerDetail) {
    ...
    return HashRateVo(
        ...
        iconColor: iconColor,
        title:
            "${Const.DOUBLE_NUMBER_FORMAT.format(MeUtils.powerForShow(powerDetail.power))} T ${S.of(context).hashrate}",
        subTitle: contract,
        validity: validity,

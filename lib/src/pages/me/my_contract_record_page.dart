...
import 'package:titan/src/pages/me/model/bill_info.dart';
...
class _MyContractRecordState extends State<MyContractRecordPage> with TickerProviderStateMixin {
                    ...
                    child: RefreshConfiguration.copyAncestor(
                      ...
                      child: TabBarView(
                        ...
                        children: _dailyBillsModels
                            .map((DailyBillsModel value) => value.type == DailyBillsType.record
                                ? WithdrawalHistory()
                                : BillHistory(type: value.type))
                            .toList(),
                      ),
                    ),
                  ),

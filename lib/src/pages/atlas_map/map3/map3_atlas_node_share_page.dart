...
class Map3AtlasNodeSharePage extends StatefulWidget {
  final Map3InfoEntity contractNodeItem;

  Map3AtlasNodeSharePage(this.contractNodeItem);

  @override
  _Map3AtlasNodeSharePageState createState() => new _Map3AtlasNodeSharePageState();
}

// todo: test_1026
class _Map3AtlasNodeSharePageState extends BaseState<Map3AtlasNodeSharePage> {
  ...
  void onCreated() {
    ...
    if (activityWallet != null) {
      ...
      bool isFromOwn = wallet.getAtlasAccount().address == widget.contractNodeItem.address;

...
class NodeJoinMemberWidgetV8 extends StatefulWidget {
  ...
  NodeJoinMemberWidgetV8(this.contractId, this.remainDay, this.shareName, this.shareUrl,
      {this.isShowInviteItem = true, this.loadDataBloc});

  @override
  State<StatefulWidget> createState() {
    return _NodeJoinMemberStateV8();
  }
}

class _NodeJoinMemberStateV8 extends State<NodeJoinMemberWidgetV8> {

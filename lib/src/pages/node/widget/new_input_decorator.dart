...
///
/// [NewInputDecorator] displays the visual elements of a Material Design text
/// field around its input [child]. The visual elements themselves are defined
/// by an [NewInputDecoration] object and their layout and appearance depend
/// on the `baseStyle`, `textAlign`, `isFocused`, and `isEmpty` parameters.
///
/// [TextField] uses this widget to decorate its [EditableText] child.
///
/// [NewInputDecorator] can be used to create widgets that look and behave like a
...
class NewInputDecorator extends StatefulWidget {
  ...
  ///
  /// If null, `const InputDecoration()` is used. Null [NewInputDecoration]
  /// properties are initialized with the corresponding values from
  /// [ThemeData.inputDecorationTheme].
  final NewInputDecoration decoration;
  ...
  /// [NewInputDecoration.focusColor] with [NewInputDecoration.fillColor] when
  /// focused, and [NewInputDecoration.fillColor] when not.
  ///
  /// Defaults to false.
  ///
  /// See also:
  ///
  ///  * [NewInputDecoration.hoverColor], which is also blended into the focus
  ...
  /// [NewInputDecoration.hoverColor] with [NewInputDecoration.fillColor] when
  /// true, and [NewInputDecoration.fillColor] when not.
  ///
  /// Defaults to false.
  ///
  /// See also:
  ///
  ///  * [NewInputDecoration.focusColor], which is also blended into the hover
  ...
  @override
  _NewInputDecoratorState createState() => _NewInputDecoratorState();

  /// The RenderBox that defines this decorator's "container". That's the
  /// area which is filled if [NewInputDecoration.filled] is true. It's the area
  /// adjacent to [NewInputDecoration.icon] and above the widgets that contain
  /// [NewInputDecoration.helperText], [NewInputDecoration.errorText], and
  /// [NewInputDecoration.counterText].
  ///
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<NewInputDecoration>('decoration', decoration));
...
class _NewInputDecoratorState extends State<NewInputDecorator> with TickerProviderStateMixin {
  ...
  NewInputDecoration _effectiveDecoration;
  NewInputDecoration get decoration {
    // todo: test_Jison
...
//    );
  ...
  @override
  void didUpdateWidget(NewInputDecorator old) {
    super.didUpdateWidget(old);
...
/// Design text field.
///
/// The [TextField] and [NewInputDecorator] classes use [NewInputDecoration] objects
/// to describe their decoration. (In fact, this class is merely the
/// configuration of an [NewInputDecorator], which does all the heavy lifting.)
///
...
class NewInputDecoration {
  ...
  /// [NewInputDecorator] defaults [isDense] to false, and [filled] to false,
  ...
  /// Defines an [NewInputDecorator] that is the same size as the input field.
  ///
  /// This type of input decoration does not include a border by default.
  ///
  /// Sets the [isCollapsed] property to true.
  const NewInputDecoration.collapsed({
  ...
  /// The border to display when the [NewInputDecorator] does not have the focus and
  /// is showing an error.
  ///
  /// See also:
  ///
  ///  * [NewInputDecorator.isFocused], which is true if the [NewInputDecorator]'s child
  ///    has the focus.
  ///  * [NewInputDecoration.errorText], the error shown by the [NewInputDecorator], if non-null.
  ///  * [border], for a description of where the [NewInputDecorator] border appears.
  ///  * [UnderlineInputBorder], an [NewInputDecorator] border which draws a horizontal
  ///    line at the bottom of the input decorator's container.
  ///  * [OutlineInputBorder], an [NewInputDecorator] border which draws a
  ///    rounded rectangle around the input decorator's container.
  ///  * [InputBorder.none], which doesn't draw a border.
  ///  * [focusedBorder], displayed when [NewInputDecorator.isFocused] is true
  ///    and [InputDecoration.errorText] is null.
  ///  * [focusedErrorBorder], displayed when [NewInputDecorator.isFocused] is true
  ///    and [InputDecoration.errorText] is non-null.
  ///  * [disabledBorder], displayed when [NewInputDecoration.enabled] is false
  ///    and [InputDecoration.errorText] is null.
  ///  * [enabledBorder], displayed when [NewInputDecoration.enabled] is true
  ///    and [InputDecoration.errorText] is null.
  final InputBorder errorBorder;

  /// The border to display when the [NewInputDecorator] has the focus and is not
  /// showing an error.
  ///
  /// See also:
  ///
  ...
  ///    rounded rectangle around the input decorator's container.
  ///  * [InputBorder.none], which doesn't draw a border.
  ///  * [errorBorder], displayed when [NewInputDecorator.isFocused] is false
  ///    and [InputDecoration.errorText] is non-null.
  ///  * [focusedErrorBorder], displayed when [NewInputDecorator.isFocused] is true
  ///    and [InputDecoration.errorText] is non-null.
  ///  * [disabledBorder], displayed when [NewInputDecoration.enabled] is false
  ...
  /// The border to display when the [NewInputDecorator] has the focus and is
  /// showing an error.
  ///
  /// See also:
  ///
  ...
  /// The border to display when the [NewInputDecorator] is disabled and is not
  /// showing an error.
  ///
  /// See also:
  ///
  ///  * [NewInputDecoration.enabled], which is false if the [NewInputDecorator] is disabled.
  ///  * [NewInputDecoration.errorText], the error shown by the [NewInputDecorator], if non-null.
  ///  * [border], for a description of where the [NewInputDecorator] border appears.
  ///  * [UnderlineInputBorder], an [NewInputDecorator] border which draws a horizontal
  ///    line at the bottom of the input decorator's container.
  ...
  /// The border to display when the [NewInputDecorator] is enabled and is not
  /// showing an error.
  ///
  /// See also:
  ///
  ...
  /// The decoration's container is the area which is filled if [filled] is
  /// true and bordered per the [border]. It's the area adjacent to
  /// [NewInputDecoration.icon] and above the widgets that contain
  /// [NewInputDecoration.helperText], [NewInputDecoration.errorText], and
  /// [NewInputDecoration.counterText].
  ///
  ...
  /// [NewInputDecoration.errorText], [NewInputDecoration.enabled],
  /// [NewInputDecorator.isFocused] and the current [Theme].
  ///
  ...
  /// Typically set to true when the [NewInputDecorator] contains a multiline
  ...
  /// Used by widgets like [TextField] and [NewInputDecorator] to create a new
  /// [NewInputDecoration] with default values taken from the [theme].
  ///
  /// Only null valued properties from this [NewInputDecoration] are replaced
  /// by the corresponding values from [theme].
  NewInputDecoration applyDefaults(InputDecorationTheme theme) {
    return copyWith(
  ...
  bool operator ==(Object other) {
    ...
    if (other.runtimeType != runtimeType)
      return false;
    return other is NewInputDecoration
        && other.icon == icon
...
/// Defines the default appearance of [NewInputDecorator]s.
///
/// This class is used to define the value of [ThemeData.inputDecorationTheme].
/// The [NewInputDecorator], [TextField], and [TextFormField] widgets use
/// the current input decoration theme to initialize null [NewInputDecoration]
/// properties.
///
/// The [NewInputDecoration.applyDefaults] method is used to combine a input
/// decoration theme with an [NewInputDecoration] object.
@immutable
class InputDecorationTheme with Diagnosticable {
  /// Creates a value for [ThemeData.inputDecorationTheme] that
  /// defines default values for [NewInputDecorator].
  ///
  ...
  /// The style to use for [NewInputDecoration.labelText] when the label is
  ...
  /// The style to use for [NewInputDecoration.helperText].
  final TextStyle helperStyle;
  ...
  /// The style to use for the [NewInputDecoration.hintText].
  ///
  /// Also used for the [labelText] when the [labelText] is displayed on
  /// top of the input field (i.e., at the same location on the screen where
  ...
  /// The style to use for the [NewInputDecoration.errorText].
  ///
  /// If null, defaults of a value derived from the base [TextStyle] for the
  /// input field and the current [Theme].
  final TextStyle errorStyle;
  ...
  /// [NewInputDecoration.filled] is true and bordered per the [border].
  /// It's the area adjacent to [NewInputDecoration.icon] and above the
  /// [NewInputDecoration.icon] and above the widgets that contain
  /// [NewInputDecoration.helperText], [NewInputDecoration.errorText], and
  /// [NewInputDecoration.counterText].
  ///
  ...
  /// Whether the decoration is the same size as the input field.
  ///
  /// A collapsed decoration cannot have [NewInputDecoration.labelText],
  /// [NewInputDecoration.errorText], or an [NewInputDecoration.icon].
  final bool isCollapsed;

  /// The style to use for the [NewInputDecoration.prefixText].
  ///
  /// If null, defaults to the [hintStyle].
  final TextStyle prefixStyle;

  /// The style to use for the [NewInputDecoration.suffixText].
  ///
  /// If null, defaults to the [hintStyle].
  final TextStyle suffixStyle;

  /// The style to use for the [NewInputDecoration.counterText].
  ///
  /// If null, defaults to the [helperStyle].
  final TextStyle counterStyle;

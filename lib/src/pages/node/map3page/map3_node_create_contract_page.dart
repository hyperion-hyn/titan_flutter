...
//      widget.fieldCallBack(text);
  ...
  void getCurrentSpend(String inputText){
    ...
    double doubleSpendManager = (double.parse(contractNodeItem.contract.minTotalDelegation) - inputValue)
        * contractNodeItem.contract.annualizedYield * contractNodeItem.contract.duration / 365 * contractNodeItem.contract.commission;
  ...
  Widget _pageView(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      Container(
          color: Colors.white,
          child: getMap3NodeProductHeadItem(context, contractNodeItem.contract, showMinDelegation: true)),
      Container(
        height: 5,

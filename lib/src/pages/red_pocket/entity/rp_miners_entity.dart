...
class RpMinersEntity extends Object {
  ...
  factory RpMinersEntity.fromJson(Map<String, dynamic> srcJson) =>
      _$RpMinersEntityFromJson(srcJson);
...
class RpMinerInfo extends Object {
  ...
  factory RpMinerInfo.fromJson(Map<String, dynamic> srcJson) =>
      _$RpMinerInfoFromJson(srcJson);

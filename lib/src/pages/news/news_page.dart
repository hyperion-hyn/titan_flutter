                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      _buildTag(S.of(context).official_announcement, OFFICIAL_ANNOUNCEMENT_TAG, isUpdate: false/*isUpdateAnnounce*/),
...
//      }
  ...
  Future _getPowerList(String categories, int tags, int page) async {
    var isZhLanguage = SettingInheritedModel.of(context, aspect: SettingAspect.language).languageModel.isZh();

...
import 'package:titan/src/pages/mine/customerServicePage.dart';
...
//          backgroundColor: Colors.white,
        ...
        body: ListView(padding: EdgeInsets.symmetric(horizontal: 0), children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  Text(S.of(context).app_name,
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Color(0xFF252525))),
                  SizedBox(
                    height: 4,
                  ),
          ...
          _buildInfoContainer(
              ...
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => CustomerServicePage(S.of(context).wx_id)));

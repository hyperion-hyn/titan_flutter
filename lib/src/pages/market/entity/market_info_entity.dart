...
class MarketInfoEntity extends Object {
  ...
  MarketInfoEntity(this.amountPrecision,this.pricePrecision,this.turnoverPrecision,this.depthPrecision,);

  MarketInfoEntity.defaultEntity(this.amountPrecision,this.pricePrecision,this.turnoverPrecision,this.depthPrecision);

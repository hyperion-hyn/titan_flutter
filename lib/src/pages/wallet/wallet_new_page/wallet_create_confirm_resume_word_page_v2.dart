...
class WalletCreateConfirmResumeWordPageV2 extends StatefulWidget {
  final String createWalletMnemonicTemp;
  final String walletName;
  final String password;

  WalletCreateConfirmResumeWordPageV2(
    this.createWalletMnemonicTemp,
    this.walletName,
    this.password,
  );
...
class _ConfirmResumeWordState extends State<WalletCreateConfirmResumeWordPageV2> {
  ...
  Future _submit() async {
    ...
    if (selectedMnemonitc.trim() == widget.createWalletMnemonicTemp.trim()) {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => FinishCreatePage(wallet),
          ));
    } else {

...
class AccountTransferService {
  ...
  Future<List<TransactionDetailVo>> getTransferList(WalletAccountVo walletAccountVo, int page) async {
  ...
  Future<List<TransactionDetailVo>> _getErc20TransferList(WalletAccountVo walletAccountVo, int page) async {
    var contractAddress = walletAccountVo.assetToken.contractAddress;
  ...
  Future<List<TransactionDetailVo>> _getEthTransferList(WalletAccountVo walletAccountVo, int page) async {

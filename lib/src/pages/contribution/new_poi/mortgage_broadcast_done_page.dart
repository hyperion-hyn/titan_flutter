...
class MortgageBroadcastDonePage extends StatefulWidget {
  final String backRouteName;

  MortgageBroadcastDonePage({this.backRouteName});

  @override
  State<StatefulWidget> createState() {
    return _MortgageBroadcastDonePageState();
  }
}

class _MortgageBroadcastDonePageState extends State<MortgageBroadcastDonePage> {

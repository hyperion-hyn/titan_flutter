...
class TextStyles {
  ...
  static TextStyle textC333S16bold = textStyle(fontSize: 16,color: DefaultColors.color333,fontWeight: FontWeight.bold);
  static TextStyle textC333S18 = textStyle(fontSize: 18, color: DefaultColors.color333);
  static TextStyle textC777S12 = textStyle(fontSize: 12, color: DefaultColors.color777);

...
class BaseError {
  ...
  static Map<String, String> errorMap = {
    ...
    "not allow to update commission by non-operator":
        S.of(Keys.rootKey.currentContext).non_operator_not_update_commission,
    ...
    "validator address not equal to the address of the validator map3 already restaked to":
        S.of(Keys.rootKey.currentContext).validator_address_not_equal_map3_restaked,
    ...
    "change on commission rate can not be more than max change rate within the same epoch":
        S.of(Keys.rootKey.currentContext).change_commission_rate_more_change_rate,
    ...
    "total delegation can not be bigger than max_total_delegation":
        S.of(Keys.rootKey.currentContext).atlas_node_more_max_delegation,

...
var ERROR_USER_CREATED = HttpResponseCodeNotSuccess(-20001, "create user error"); //用户创建失败
...
List<HttpResponseCodeNotSuccess> ERROR_CODE_LIST = [
  HttpResponseCodeNotSuccess(-10000, "Unknown error"),
  HttpResponseCodeNotSuccess(-10001, "Invalid request params"),
  HttpResponseCodeNotSuccess(-10002, "unauthorized"),
  HttpResponseCodeNotSuccess(-1003, "access denied"),
  HttpResponseCodeNotSuccess(-1004, "Content conflict"),
  HttpResponseCodeNotSuccess(-1005, "Not content"),
  HttpResponseCodeNotSuccess(-1006, "network error"),
  HttpResponseCodeNotSuccess(-1007, "out of range"),
  HttpResponseCodeNotSuccess(-20001, "create user error"),
  HttpResponseCodeNotSuccess(-20002, "user already exist"),
  HttpResponseCodeNotSuccess(-20004, "update user error"),
  HttpResponseCodeNotSuccess(-20005, "incorrect verification code"),
  HttpResponseCodeNotSuccess(-20006, "incorrect invitation code"),
  HttpResponseCodeNotSuccess(-20007, "fail to login"),
  HttpResponseCodeNotSuccess(-20008, "fail to reset password"),
  HttpResponseCodeNotSuccess(-20009, "check-in reach the upper limit"),
  HttpResponseCodeNotSuccess(-20010, "check-in interval is 30 minutes."),
];

Map<int, HttpResponseCodeNotSuccess> ERROR_CODE_DEFINITION =
    Map.fromIterable(ERROR_CODE_LIST, key: (errorTemp) => errorTemp.code, value: (errorTemp) => errorTemp);

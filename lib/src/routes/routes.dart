...
class Routes {
  ...
  static const String map3node_create_contract_page =
      '/map3node/create_contract_page';
  static const String map3node_join_contract_page =
      '/map3node/join_contract_page';
  static const String map3node_send_confirm_page =
      '/map3node/send_confirm_page';
  static const String map3node_broadcast_success_page =
      '/map3node/broadcase_success_page';
  static const String map3node_contract_detail_page =
      '/map3node/contract_detail_page';
  static const String map3node_share_page = '/map3node/share_page';
  static const String map3node_pre_create_contract_page =
  ...
  static void configureRoutes(Router router) {
    ...
    router.define(contribute_tasks_list,
        handler: contributionTasksHandler,
        transitionType: pushNewPageTransitionType);
    router.define(contribute_done,
    ...
    router.define(map3node_create_wallet,
        handler: map3NodeCreateWalletHandler,
        transitionType: pushNewPageTransitionType);
